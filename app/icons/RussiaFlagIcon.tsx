...
const RussiaFlag: React.FC<CustomIconComponentProps> = ({ size = 16 }) => (
  <svg
...
const RussiaFlagIcon: React.FC<Partial<CustomIconComponentProps>> = (props) => (
  <Icon component={() => <RussiaFlag {...props} />} />
);
