...
const UnitedStates: React.FC<CustomIconComponentProps> = ({ size = 16 }) => (
  <svg
...
const UnitedStatesIcon: React.FC<Partial<CustomIconComponentProps>> = (
  props,
) => <Icon component={() => <UnitedStates {...props} />} />;

export default UnitedStatesIcon;
